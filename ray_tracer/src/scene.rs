            ...
            objects: vec![
                Element {
                    ...
                    shape: ShapeType::RectangleYZ(RectangleYZ::new(
                        0.0, 555.0, 0.0, 555.0, 555.0, true,
                    )),
                },
                Element {
                    id: ElementId::new(),
                ...
                Element {
                    ...
                    shape: ShapeType::RectangleXZ(RectangleXZ::new(
                        213.0, 343.0, 227.0, 332.0, 554.0, true,
                    )),
                },
                Element {
                    id: ElementId::new(),
                ...
                Element {
                    ...
                    shape: ShapeType::RectangleXY(RectangleXY::new(
                        0.0, 555.0, 0.0, 555.0, 555.0, false,
                    )),
                },
                Element {
                    id: ElementId::new(),
                    material: white.clone(),
                    shape: ShapeType::Box(Box::new(
